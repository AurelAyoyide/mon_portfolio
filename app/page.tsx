...
export default function Home() {
  ...
  const projects = [
    ...
    {
      title: "Bono School",
      tags: ["Next.js", "React", "Tailwind", "MySQL"],
    ...
    },
    {
      ...
      iframeUrl: "https://luxuriousng.netlify.app/",
      demoUrl: "https://luxuriousng.netlify.app/",
      repoUrl: "https://github.com/AurelAyoyide/jr_luxurious.ng",
    ...
    {
      title: "THE DROP (MrSneakers)",
      tags: ["React", "Vite", "Tailwind", "Framer Motion"],
      iframeUrl: "https://mrsneakers.netlify.app/",
      demoUrl: "https://mrsneakers.netlify.app/",
      repoUrl: "https://github.com/AurelAyoyide/MrSneaker",
    ...
    {
      title: "ClothingColorfull",
      tags: ["React", "Vite", "Tailwind", "Cormorant"],
      iframeUrl: "https://clothingcolorfull.netlify.app/",
      demoUrl: "https://clothingcolorfull.netlify.app/",
      repoUrl: "https://github.com/AurelAyoyide/ClothingColorfull",
    ...
    {
      title: "ReloMidi (GrammyMelodyMind)",
      tags: ["React", "TypeScript", "Vite", "Web Audio"],
      iframeUrl: "https://grammymelodymind.netlify.app/",
      demoUrl: "https://grammymelodymind.netlify.app/",
      repoUrl: "https://github.com/AurelAyoyide/melodymind",
    ...
    {
      title: "Pineapple",
      tags: ["Next.js", "API TMDB", "Tailwind"],
      iframeUrl: "https://pineapple2025.vercel.app/",
      demoUrl: "https://pineapple2025.vercel.app/",
      description: "Site web pour découvrir et critiquer des films et séries. Utilise l'API TMDB pour récupérer les informations des films. Les pages se chargent rapidement grâce au système de rendu côté serveur de Next.js. Design responsive qui s'adapte à tous les écrans."
    },
    {
      title: "AurelOS Portfolio",
      tags: ["Next.js", "TypeScript", "CSS", "ASCII"],
      iframeUrl: "https://aurelayoyide.netlify.app/",
      demoUrl: "https://aurelayoyide.netlify.app/",
      repoUrl: "https://github.com/AurelAyoyide/mon_portfolio",
      description: "Portfolio original présenté comme un terminal d'ordinateur interactif. Contient une séquence de démarrage animée, plus de 15 commandes utilisables (comme whoami, skills, projects), un mini-jeu Snake intégré, et plusieurs thèmes de couleurs au choix."
    },
    {
      title: "YOWL",
      tags: ["Laravel", "Vue.js", "MySQL"],
      iframeUrl: "https://yowlraib.netlify.app/",
      demoUrl: "https://yowlraib.netlify.app/",
      description: "Réseau social permettant de commenter n'importe quel contenu du web (vidéos, articles, produits). Système de discussions avec réponses imbriquées et votes. Les utilisateurs peuvent se connecter, échanger des commentaires et recevoir des notifications en temps réel."
    }
  ]
